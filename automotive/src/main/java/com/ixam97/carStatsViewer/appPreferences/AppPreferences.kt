...
import com.mbuehler.carStatsViewer.utils.Exclude
...
class AppPreferences(
    ...
    private val LogTargetAddress = AppPreference<String>(context.getString(R.string.preference_log_target_address_key), "mbuehler@mbuehler.de", sharedPref)
