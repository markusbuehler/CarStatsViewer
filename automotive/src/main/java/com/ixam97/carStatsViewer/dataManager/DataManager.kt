...
import com.mbuehler.carStatsViewer.InAppLogger
import com.mbuehler.carStatsViewer.plot.enums.PlotDimension
import com.mbuehler.carStatsViewer.plot.enums.PlotHighlightMethod
import com.mbuehler.carStatsViewer.plot.enums.PlotLabelPosition
import com.mbuehler.carStatsViewer.plot.enums.PlotLineLabelFormat
import com.mbuehler.carStatsViewer.plot.objects.*
...
class DataManager(val printableName: String) {
    ...
    /** Current power in mW */
    val currentPower get() = com.mbuehler.carStatsViewer.activities.emulatorPowerSign * (CurrentPower.value ?: 0F) as Float
    /** Current gear selection */
