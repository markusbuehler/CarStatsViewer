...
import com.mbuehler.carStatsViewer.plot.enums.PlotDimensionX
...
class DataManager(val printableName: String) {
    ...
    /** Current power in mW */
    val currentPower get() = com.mbuehler.carStatsViewer.emulatorPowerSign * (CurrentPower.value ?: 0F) as Float
    /** Current gear selection */
