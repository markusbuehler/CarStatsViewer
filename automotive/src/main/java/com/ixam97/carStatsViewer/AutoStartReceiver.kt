...
import com.mbuehler.carStatsViewer.ui.activities.PermissionsActivity
...
class AutoStartReceiver: BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent?) {
        ...
        if ((intent?.action?: "") == "com.mbuehler.carStatsViewer.NOTIFICATION_DELETE") {
        ...
        val deleteIntent = PendingIntent.getBroadcast(
            ...
            Intent(context.applicationContext, AutoStartReceiver::class.java).apply {
                action = "com.mbuehler.carStatsViewer.NOTIFICATION_DELETE"
            },
